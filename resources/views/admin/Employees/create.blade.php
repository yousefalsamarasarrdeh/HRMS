...
@endsection
@section("css")
    <link rel="stylesheet" href="{{ asset('admin2/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin2/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
@endsection
        ...
        text-align: right !important;">
                    ...
                    <div class="col-md-12">
                        <div class="form-group text-center">
                            <button class="btn btn-sm btn-success" type="submit" name="submit">اضف  </button>
...
@endsection
@section("script")
    <script src="{{ asset('admin2/plugins/select2/js/select2.full.min.js') }}"> </script>
    <script src="{{ asset('admin2/js/employees.js') }}"> </script>
    <script>
