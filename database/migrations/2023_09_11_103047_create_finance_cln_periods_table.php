...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('finance_cln_periods', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('finance_calelanders_id');
            $table->foreign('finance_calelanders_id')->references('id')->on('finance_calelanders')->onDelete('cascade')->onUpdate('cascade');
